...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_NONE, 5139, 9240, 5368, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 5139, 9240, 5513, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 5139, 9240, 5667, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 5139, 9240, 5798, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 5139, 9240, 5889, 0, 0, 0, 0x00000000, bhvCoinFormation),
