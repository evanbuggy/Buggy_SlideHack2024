...
const GeoLayout wmotr_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 1272, 4085, -4164, 79, -71, 1, wmotr_dl_cloud_006_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 1570, 4079, -6661, 75, 31, -14, wmotr_dl_cloud_007_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 8553, 5511, 13727, 75, -15, 41, wmotr_dl_cloud_008_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5441, -7962, 1819, wmotr_dl_Cube_004_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4732, -7722, 3481, 0, -135, 0, wmotr_dl_Cube_019_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -377, -5713, -4140, -7, -135, -7, wmotr_dl_Cube_020_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -6072, 2431, -1897, 90, 0, 0, wmotr_dl_DrawCall_76_007_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -2996, 1894, 6545, 90, 0, 0, wmotr_dl_DrawCall_76_008_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, 6857, 3582, 9488, 90, 0, 23, wmotr_dl_DrawCall_76_009_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -11581, 7073, -12869, 90, 0, 18, wmotr_dl_DrawCall_76_010_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 3472, -6164, 794, 0, 45, 0, wmotr_dl_L_is_real_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, 3126, -5855, 592, 0, -119, 0, wmotr_dl_Plane_007_mesh_layer_4),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -10488, 2831, 12393, 0, 91, 0, wmotr_dl_Plane_010_mesh_layer_4),
