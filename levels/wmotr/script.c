...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 1338, 4620, -4041, 0, -1, 0, (5 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, -371, -1274, -3685, 0, 144, 0, (5 << 16), bhvExclamationBox),
		OBJECT(MODEL_YELLOW_COIN, -13610, 8314, -13244, 0, -1, 0, (5 << 16), bhvOneCoin),
		OBJECT(MODEL_EXCLAMATION_BOX, 4710, -5115, 3154, 0, 59, 0, (5 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 43, -6663, -6, 0, 45, 0, (7 << 16), bhvWarpPipe),
		...
		OBJECT(MODEL_NONE, -10490, 2830, 12398, 0, 0, 0, (8 << 16), bhvFadingWarp),
		...
		OBJECT(MODEL_NONE, 3133, -5831, 607, 0, 0, 0, 0x000B0000, bhvFadingWarp),
		...
		OBJECT(MODEL_YELLOW_COIN, 11741, 4927, -12555, 0, -1, 0, (5 << 16), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 8048, 4866, -7570, 0, -1, 0, (5 << 16), bhvOneCoin),
		...
		OBJECT(MODEL_GOOMBA, 6482, 5350, 10245, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 10926, 6330, -12968, 0, 0, 0, 0x00000000, bhvGoomba),
		...
		OBJECT(MODEL_NONE, 208, 7531, -25, 0, -66, 0, (0 << 16), bhvCoinFormation),
