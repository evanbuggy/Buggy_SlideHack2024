...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -733, -6614, -286, 0, 66, 0, (33 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_YELLOW_COIN, 208, 7531, 124, 0, -66, 0, (0 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_YELLOW_COIN, -339, 7531, 124, 0, -66, 0, (0 << 16), bhvCoinFormation),
