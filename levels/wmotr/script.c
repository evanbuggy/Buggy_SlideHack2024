...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		OBJECT(MODEL_GOOMBA, -8651, 1779, 12228, 0, -99, 0, (13 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -10372, 1770, 10480, 0, -99, 0, (13 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -12434, 1921, 11975, 0, -99, 0, (13 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -10836, 2138, 14430, 0, -99, 0, (13 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -11665, 1999, 13595, 0, -99, 0, (13 << 16), bhvGoomba),
		...
		OBJECT(MODEL_YELLOW_COIN, 208, 7531, 2, 0, -66, 0, (0 << 16), bhvCoinFormation),
		OBJECT(MODEL_YELLOW_COIN, -13241, 5274, 4603, 0, -158, 0, (0 << 16), bhvCoinFormation),
