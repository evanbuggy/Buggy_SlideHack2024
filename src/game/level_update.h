...
enum HUDDisplayFlag {
    ...
    HUD_DISPLAY_FLAG_FACE             = (1 <<  7),
    HUD_DISPLAY_FLAG_TEXT             = (1 <<  7),
#ifdef BREATH_METER
    ...
    HUD_DISPLAY_DEFAULT = (HUD_DISPLAY_FLAG_LIVES | HUD_DISPLAY_FLAG_COIN_COUNT | HUD_DISPLAY_FLAG_STAR_COUNT | HUD_DISPLAY_FLAG_CAMERA_AND_POWER | HUD_DISPLAY_FLAG_KEYS | HUD_DISPLAY_FLAG_UNKNOWN_0020 | HUD_DISPLAY_FLAG_FACE | HUD_DISPLAY_FLAG_TEXT)
};
